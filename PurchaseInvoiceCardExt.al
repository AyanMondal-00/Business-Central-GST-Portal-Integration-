pageextension 50122 PurchaseInvoiceCardExt extends "Purchase Invoice"
{
    layout
    {
        addlast(General)
        {
            group("Travel Information")
            {
                ...
                field("Travel Amount"; Rec."Travel Amount")
                {
                    ApplicationArea = All;
                }
                ...
                field("Name List"; Rec."Name List")
                {
                    ApplicationArea = All;
                }

                field("Cost Revision"; Rec."Cost Revision")
                {
                    ApplicationArea = All;
                }
            }
